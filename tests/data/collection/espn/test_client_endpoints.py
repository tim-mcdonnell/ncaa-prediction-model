...
class TestESPNClientEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_scoreboard_endpoint(self):
        """Test the scoreboard endpoint with validation."""
    ...
    @pytest.mark.asyncio
    async def test_teams_endpoint(self):
    ...
    @pytest.mark.asyncio
    async def test_team_roster_endpoint(self):
    ...
    @pytest.mark.asyncio
    async def test_game_summary_endpoint(self):
    ...
    async def test_teams_response_pipeline(self):
        """Test the pipeline from API request to TeamsResponse for teams endpoint."""
        async with ESPNClient() as client:
    ...
    async def test_all_athletes_pagination(self):
        """Test pagination logic for get_all_athletes."""
        async with ESPNClient() as client:
